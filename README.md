...
**Dyslexic**  is a webpage and Python AI backend designed to bridge the gap between standard web content and neurodivergent processing needs. Unlike simple "overlay" extensions that just change fonts, Dyslexic uses **Natural Language Processing (NLP)**, **Stylometric Analysis**, and **Deep Learning** to understand the *context* of text, not just its spelling.
